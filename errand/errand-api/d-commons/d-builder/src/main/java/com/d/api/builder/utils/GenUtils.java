package com.d.api.builder.utils;

import com.d.api.builder.entity.ColumnEntity;
import com.d.api.builder.entity.TableEntity;
...
public class GenUtils {
	...
	public static Configuration getConfig(){
		try {
			return new PropertiesConfiguration("builder.properties");
